...
class BiEncoder(torch.nn.Module):
    ...
    """
    def __init__(self, qry_encoder_name_or_path, ctx_encoder_name_or_path, hypers):
        super().__init__()
        self.qry_model = EncoderWrapper(DPRQuestionEncoder.from_pretrained(qry_encoder_name_or_path, cache_dir='data/cache'))
        self.ctx_model = EncoderWrapper(DPRContextEncoder.from_pretrained(ctx_encoder_name_or_path, cache_dir='data/cache'))
